                                    ...
                                    <div class="card">
                                        ...
                                        <div id="tab-mail-notifications-admin" class="collapse ml-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="NOTIFICATIONS_ADMIN_EMAIL" class="form-control" value="{{ config('settings.notifications.admin.email') }}">
                                            </div>
                                            <div class="form-group">
                                                <div class="form-check">
                                                    <input type="hidden" name="NOTIFICATIONS_ADMIN_REGISTRATION_ENABLED" value="false">
                                                    <input type="checkbox" name="NOTIFICATIONS_ADMIN_REGISTRATION_ENABLED" value="true" class="form-check-input" {{ config('settings.notifications.admin.registration.enabled') ? 'checked="checked"' : '' }}>
                                                    <label class="form-check-label">
                                                        {{ __('Notify when a new user signs up') }}
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="form-inline">
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            ...
                                                            <input type="checkbox" name="NOTIFICATIONS_ADMIN_GAME_WIN_ENABLED" value="true" class="form-check-input" {{ config('settings.notifications.admin.game.win.enabled') ? 'checked="checked"' : '' }}>
                                                            <label class="form-check-label">
                                                                {{ __('Notify when a user wins more than (in one game)') }}
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="input-group ml-2">
                                                        <input type="text" name="NOTIFICATIONS_ADMIN_GAME_WIN_TRESHOLD" class="form-control" value="{{ config('settings.notifications.admin.game.win.treshold') }}">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">{{ __('credits') }}</span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-inline">
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            ...
                                                            <input type="checkbox" name="NOTIFICATIONS_ADMIN_GAME_LOSS_ENABLED" value="true" class="form-check-input" {{ config('settings.notifications.admin.game.loss.enabled') ? 'checked="checked"' : '' }}>
                                                            <label class="form-check-label">
                                                                {{ __('Notify when a user loses more than (in one game)') }}
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="input-group ml-2">
                                                        <input type="text" name="NOTIFICATIONS_ADMIN_GAME_LOSS_TRESHOLD" class="form-control" value="{{ config('settings.notifications.admin.game.loss.treshold') }}">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">{{ __('credits') }}</span>
                                                        </div>
                                                    </div>
